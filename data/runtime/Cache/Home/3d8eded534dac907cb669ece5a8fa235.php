         ...
         <!-- BEGIN SIDEBAR MENU -->
          <ul class="sidebar-menu">
              ...
              <li class="sub-menu">
                  ...
                  <ul class="sub">
                      <li><a class="menu_jump" href="/Home/account">用户管理</a></li>
            ...
            <div class="row-fluid">
                ...
                <div class="metro-nav">
                    <div class="metro-nav-block nav-block-orange">
                        <a data-original-title="" href="index.html#">
                            <i class="icon-user"></i>
                 ...
                 <div class="span6">
                     ...
                     <div class="widget blue">
                         ...
                         <div class="widget-body">
                             ...
                             <div class="space10"></div>
                             <a href="index.html#" class="pull-right">View all notifications</a>
                         ...
                         <div class="widget-body">
                             <div class="timeline-messages">
                                 ...
                                 <div class="msg-time-chat">
                                     <a class="message-img" href="index.html#"><img alt="" src="/static/images/metro/avatar1.jpg" class="avatar"></a>
                                     <div class="message-body msg-in">
                                         <span class="arrow"></span>
                                         <div class="text">
                                             <p class="attribution"><a href="index.html#">Jhon Doe</a> at 1:55pm, 13th April 2013</p>
                                 ...
                                 <!-- Comment -->
                                 <div class="msg-time-chat">
                                     <a class="message-img" href="index.html#"><img alt="" src="/static/images/metro/avatar2.jpg" class="avatar"></a>
                                     <div class="message-body msg-out">
                                         <span class="arrow"></span>
                                         <div class="text">
                                             <p class="attribution"> <a href="index.html#">Jonathan Smith</a> at 2:01pm, 13th April 2013</p>
                                 ...
                                 <div class="msg-time-chat">
                                     ...
                                     <div class="message-body msg-in">
                                         <span class="arrow"></span>
                                         <div class="text">
                                             <p class="attribution"><a href="index.html#">Jhon Doe</a> at 2:03pm, 13th April 2013</p>
                                 ...
                                 <div class="msg-time-chat">
                                     ...
                                     <div class="message-body msg-out">
                                         <span class="arrow"></span>
                                         <div class="text">
                                             <p class="attribution"><a href="index.html#">Jonathan Smith</a> at 2:05pm, 13th April 2013</p>
...
<!-- BEGIN FOOTER -->
   ...
   <!-- 
     -->
	<!--script-->	
	<script type="text/javascript" src="/static/js/head.js" data-headjs-load="/static/js/he_common.js"></script>
